  ...
  return (
    <Card className="bg-dashboard-card border-dashboard-border">
      <CardHeader className="pb-2">
        <CardTitle className="text-base font-medium text-dashboard-accent">ESTOQUE MATRIZ (BARUERI)</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="text-center">
           <Boxes className="h-5 w-5 mx-auto mb-1 text-dashboard-orange" />
            <p className="text-sm text-muted-foreground">Kits Completo</p>
