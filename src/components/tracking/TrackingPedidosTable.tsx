...
const formatDateFull = (dt: any) => {
  ...
  // Try to keep full date with day-of-week if present
  return str;
};
  ...
  return (
    <Card className="bg-card border-border">
      ...
      <CardContent className="p-0">
        <div className="overflow-x-auto overflow-y-auto max-h-[500px]" style={{ scrollbarWidth: "thin", scrollbarGutter: "stable" }}>
          <style>{`
            .tracking-pedidos-scroll::-webkit-scrollbar { width: 8px; height: 8px; }
            .tracking-pedidos-scroll::-webkit-scrollbar-track { background: hsl(0, 0%, 10%); }
            .tracking-pedidos-scroll::-webkit-scrollbar-thumb { background: hsl(0, 0%, 30%); border-radius: 4px; }
            .tracking-pedidos-scroll::-webkit-scrollbar-thumb:hover { background: hsl(0, 0%, 40%); }
            .tracking-pedidos-scroll { overflow: scroll !important; }
          `}</style>
          <div className="tracking-pedidos-scroll overflow-x-scroll overflow-y-auto max-h-[500px]">
