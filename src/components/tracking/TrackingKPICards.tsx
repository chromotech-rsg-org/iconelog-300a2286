    ...
    <div className="flex gap-2 h-full items-stretch">
      ...
      <Card className="bg-card border-primary/60 border-2 flex-1 min-w-0">
        <CardContent className="p-3 flex flex-col items-center justify-center h-full">
          <span className="text-[11px] text-muted-foreground uppercase tracking-wider font-medium">Quantidade de Pedidos</span>
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-1.5 flex-1 min-w-0">
        ...
        >
          <CardContent className="p-2 text-center flex flex-col justify-center h-full">
            <span className="text-[10px] text-muted-foreground leading-tight">Qtde no Prazo</span>
            <p className="text-xl font-bold text-green-400 leading-tight">{formatNumber(kpis.noPrazo)}</p>
          </CardContent>
        </Card>

        <Card className="bg-card border-border">
          <CardContent className="p-2 text-center flex flex-col justify-center h-full">
            <span className="text-[10px] text-muted-foreground leading-tight">% no Prazo</span>
            <p className="text-xl font-bold text-green-400 leading-tight">{kpis.percNoPrazo.toFixed(2)}%</p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-2 text-center flex flex-col justify-center h-full">
            <span className="text-[10px] text-muted-foreground leading-tight">Qtde fora do Prazo</span>
            <p className="text-xl font-bold text-red-400 leading-tight">{formatNumber(kpis.foraPrazo)}</p>
          </CardContent>
        </Card>

        <Card className="bg-card border-border">
          <CardContent className="p-2 text-center flex flex-col justify-center h-full">
            <span className="text-[10px] text-muted-foreground leading-tight">% fora do Prazo</span>
            <p className="text-xl font-bold text-red-400 leading-tight">{kpis.percForaPrazo.toFixed(2)}%</p>
          </CardContent>
        </Card>
      </div>
    </div>
